...
from py_apollo_cli.util import *

version = sys.version_info.major

if version == 2:
    from py_apollo_cli.python_2x import *

if version == 3:
    from py_apollo_cli.python_3x import *
...
class ApolloClient(object):
    ...
    def __init__(self, config_url, app_id, cluster='default', secret='', start_hot_update=True,
        ...
        self._cache_file_path = os.path.expanduser('~') + f'/.apollo/{app_id}/cache/'
